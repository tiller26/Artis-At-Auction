<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddClothing.aspx.cs" Inherits="Project_Backup.AddClothing" %>
                                    ...
                                    <div class="form-border">
                                        ...
                                        <div>
                                            ...
                                            <div runat="server" id="extraDetails">
                                                ...
                                                <div class="row">
                                                    <h6>What type of clothing is it? </h6>
                                                    <input runat="server" id="pType" type="text" placeholder="e.g Jacket" />
                                                </div>
                                                <div class="row mb-5">
                                                    <h6>What type of fabric is used?</h6>
                                                    <input runat="server" id="pFabric" type="text" placeholder="e.g Cotton" />
                                                </div>
                                                <div class="row mb-5">
                                                    <h6>Size of the clothing?</h6>
                                                    <input runat="server" id="pSize" type="text" placeholder="e.g M (for medium)" />
                                                </div>
                                            </div>
