<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SingleInvoice.aspx.cs" Inherits="Project_Backup.SingleInvoice" %>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="common-left">
                                        <h4>Invoice Details (<span runat="server" id="date"></span>)</h4>
                                    </div>
                                </div>
